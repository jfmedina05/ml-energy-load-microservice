...
for i in range(0, n_requests):
    ...
    #response = requests.get('http://149.165.172.157:8080/e222/prediction?filename=X_test.csv')
    
    #Test the performance of the upload/predict operation
    url = 'http://149.165.172.157:8080/e222/prediction'
